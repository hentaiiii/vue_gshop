...
<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="isShowBuilltin = true">
        ...
        <div class="shop-message">
          <span class="shop-message-detail">配送费{{info.deliveryPrice}}</span>
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowBuilltin">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="isShowBuilltin = false"></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="isShowBuilltin = false"></div>
      </div>
    </transition>
    ...
    <transition name="move">
      <div class="activity-sheet" v-show="isShowSupports">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item" :class="activeColor[support.type]" v-for="(support, index) in info.supports" :key="index">
              <span class="content-tag">
